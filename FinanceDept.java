...
public class FinanceDept extends JFrame {
    ...
    // Declare elements for financial statistics
    ...
    private void updateStudentFinanceTable() {
        ...
        // Get the table model & clear the table
        ...
        try (Connection connection = DriverManager.getConnection(url, DBusername, DBpassword);
            ...
            while (resultSet.next()) {
                ...
                dataList.add(new Object[]{studentID, studentName, complete, incomplete, noProgress});
            }

            // TODO: Use Bubble sort to sort the table by ID
            for (int i = 0; i < dataList.size() - 1; i++) {
                for (int j = 0; j < dataList.size() - i - 1; j++) {
                    String id1 = dataList.get(j)[0].toString();
                    String id2 = dataList.get(j + 1)[0].toString();
    ...
    private void calculateFinancialStatistics() {
        ...
        // Process the transactions in the queue
        processTransactions();
    }
    ...
    // TODO: Method to process transactions in the queue
    private void processTransactions() {
        // Process each transaction in the queue
